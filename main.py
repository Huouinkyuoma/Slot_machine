...
def get_num_of_lines():
    while True:
        lines = input("Enter number of lines of slot: (1-" + str(MAX_LINES) + ") ")
        if lines.isdigit():
            lines = int(lines)
...
def spin(balance):
     ...
     while True:
        ...
        if total_bet > balance:
            print(
                f"You do not have enough to bet that amount, your currint balance is: ${balance}"
            )
        else:
            break  
